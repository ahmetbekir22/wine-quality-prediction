...
class WineQualityPredictor:
    ...
    def train_classification_model(self):
        ...
        test_data.to_csv('test_data_red_classification.csv', index=False)
        ...
        joblib.dump(best_model, 'classification_red_model.pkl')
...
if __name__ == "__main__":
    predictor = WineQualityPredictor('wine_quality_data/winequality-red.csv')
