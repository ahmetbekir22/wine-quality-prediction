...
# Veri yükleme
data = pd.read_csv('wine_quality_data/winequality-red.csv', sep=';', decimal='.')
...
test_data.to_csv("test_data_red_wine.csv", index=False)
...
# Modeli kaydetme
joblib.dump(model, "xgboost_red_model.pkl")
print("Model saved succesfully: xgboost_red_model.pkl")